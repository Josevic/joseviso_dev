<!-- Social Networks links -->
		...
		<div class="row">
			<div class="span7">
				<button id="button_show" class="btn btn-large" type="button">Mostrar cuentas poco usadas</button>
	...
	<button id="button_hide" class="btn btn-large" type="button" style="display:none;">Ocultar cuentas poco usadas</button>	
	<hr/>